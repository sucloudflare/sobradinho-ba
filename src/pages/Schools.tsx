...
export function Schools() {
  const schools = [
    {
      name: 'Escola Municipal Gestão Compartilhada Maria Jóse',
      description: 'Ensino Fundamental completo com ótima estrutura.',
      image: 'https://acaopopular.net/jornal/wp-content/uploads/2019/03/escola-militar-sobradinho8-620x349.jpg',
      stats: {
        students: '800+',
        teachers: '45',
        classrooms: '20'
    ...
    },
    {
      ...
      image: 'https://escolaverde.org/site/wp-content/uploads/2018/07/01.jpg',
      stats: {
        students: '1200+',
        teachers: '60',
        classrooms: '30'
    ...
    {
      name: 'Faculdade em Sobradinho',
      description: 'Formação superior profissionalizante.',
      image: 'https://escolaverde.org/site/wp-content/uploads/2015/06/Escola-Municipal-Paulo-Pacheco.jpg',
      stats: {
        students: '500+',
        teachers: '30',
        classrooms: '15'
